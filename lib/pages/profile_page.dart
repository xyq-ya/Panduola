                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          children: const [
                            Text('234', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF2563EB))),
                            SizedBox(height: 4),
                            Text('任务数', style: TextStyle(fontSize: 12, color: Colors.grey)),
                          ]
                        )
                      ),
                      Container(
                        ...
                        child: Column(
                          children: const [
                            Text('92%', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.green)),
                            SizedBox(height: 4),
                            Text('完成率', style: TextStyle(fontSize: 12, color: Colors.grey)),
                          ]
                        )
                      ),
                    ],
